...
Two Parts of Express that I learned would probably have to be that it is very similar to how React works for the backend portion of coding. AS well Express can be used to better serve the functionality that middleware already implements.

- [x] Describe Middleware?

Middleware are pieces of code that must be put in the correct order to be executed n the form of functions. There are three types of Middle ware.. Built in middle ware custom middleware and third party middleware.

- [X] Describe a Resource?

Source that can resemble Data tha can be pulled into the API

- [X] What can the API return to help clients know if a request was successful?

It can say the server is running.
